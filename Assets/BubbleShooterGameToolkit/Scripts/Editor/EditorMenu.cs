...
namespace com.kshkum.ShootGame.Scripts.Editor
{
    ...
    public static class EditorMenu
    {
        ...
        {
            EditorSceneManager.OpenScene($"Assets/com.kshkum.ShootGame/Scenes/main.unity");
        }

        [MenuItem("Tools/Bubble Shooter/Scenes/Map scene &2")]
        public static void MapScene()
        {
            EditorSceneManager.OpenScene($"Assets/com.kshkum.ShootGame/Scenes/map.unity");
        }
        ...
        {
            EditorSceneManager.OpenScene($"Assets/com.kshkum.ShootGame/Scenes/test.unity");
        }

        [MenuItem("Tools/Bubble Shooter/Level editor/Editor _C", priority = 1)]
        public static void LevelEditor()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Levels/Level_1.asset");
        }
        ...
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/BoostSettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Debug settings")]
        public static void DebugSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/DebugSettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Game settings", priority = 3)]
        public static void GameSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/GameSettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Gameplay settings")]
        public static void GameplaySettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/GameplaySettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Target settings")]
        public static void TargetSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Targets/Balls.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Coins Shop settings")]
        public static void ShopSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/ShopSettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Power settings")]
        public static void PowerSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/PowerSettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Lucky spin settings")]
        public static void SpinSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/SpinSettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Daily bonus settings")]
        public static void DailyBonusSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/DailyBonusSettings.asset");
        }

        [MenuItem("Tools/Bubble Shooter/Settings/Ads settings")]
        public static void AdsSettings()
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/com.kshkum.ShootGame/Resources/Settings/AdsSettings.asset");
        }
